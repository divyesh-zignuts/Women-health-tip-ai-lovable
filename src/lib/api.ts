...
): Promise<ApiResponse<HealthTipsResponse>> {
  try {
...
export const mockHealthTips: HealthTipsResponse = {
  HealthTips: {
    summary:
      "<p>Dial in your fertile window with a simple plan for next cycle—clear signs, smart timing, and stress‑light routines.</p>",
  ...
  ProductRecommendation: [
    {
      ...
      category: "Supplement",
      description:
        "Complete multivitamin with iron, folate, and B vitamins for reproductive health support",
    },
    {
      name: "AMH Test Kit",
      category: "Test",
      description:
        "At-home Anti-Müllerian Hormone test to assess ovarian reserve",
    },
  ],
};
      ...
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Based on your health profile, here are personalized recommendations
        ...
        <div className="grid gap-6">
            ...
            <CardContent>
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: tipsData.HealthTips.summary,
                }}
              />
            </CardContent>
          </Card>
          ...
          <Card className="health-card">
            ...
            <CardContent>
              <div
                className="text-muted-foreground prose prose-sm max-w-none"
                dangerouslySetInnerHTML={{ __html: tipsData.HealthTips.tips }}
              />
            </CardContent>
          </Card>
        </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Based on your health profile, here are evidence-based product
